...
class BlootoothA2DSink {
  public: 
    ...
    esp_a2d_connection_state_t get_conn_state();
    esp_a2d_audio_state_t get_audio_state();
    esp_a2d_mct_t get_audio_type();

    uint32_t get_remote_features();
    ...
    // to get the tasty audio track name
    String get_track_name();
    String get_album_name();
    String get_artist_name();
    String get_track_length();
    String get_track_pos();
  ...
  private:
    ...
    String audio_trackattr;
    String audio_albumattr;  
    String audio_artistattr;
    String audio_timeattr;
    uint32_t audio_posattr = 0;
    uint32_t avrc_remote_features = 0;
